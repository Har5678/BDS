...
const Ballb = () => {
  ...
  const RegisterButton = () => (
    <div className="mt-6">
      <Link
        to="/Registration"
        className="inline-block bg-[#920C24] hover:bg-[#7a0a1d] text-white font-semibold px-6 py-3 rounded-lg shadow-md transition-all duration-300"
      >
        Register Now
      </Link>
    </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-4 md:gap-8 px-4 md:px-12 py-10">
          ...
          <div className="md:hidden mb-4 flex justify-start items-center">
            <button
              ...
              className="flex items-center gap-2 text-[#920C24] font-semibold text-lg px-3 py-2 border border-gray-300 rounded-lg shadow-sm hover:bg-gray-100 transition-all duration-200"
            >
          ...
          <div
            ...
            } md:block w-full md:w-1/5 mb-4 md:mb-0 transition-all duration-300`}
          >
          ...
          <div className="flex-1 md:w-4/5 bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-200 space-y-4 md:space-y-6 text-gray-700 leading-relaxed text-justify">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-[#920C24]">
              About the Program
            </h2>
            <p>
            ...
            <p>
              <strong>Eligibility:</strong> Completion of 10+2 or equivalent examination from a recognized board with a minimum aggregate of 50% marks.
            </p>
            <p>
              <strong>Course Duration:</strong> Full-time integrated <strong>5-year program</strong> structured across <strong>10 semesters</strong>.
            </p>
