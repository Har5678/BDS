...
const LawyeringSkills = () => {
  ...
  return (
    <div className="pb-16">
      {/* Hero Section */}
      <div
        className="relative bg-cover bg-center h-[50vh] sm:h-[55vh] md:h-[60vh] flex items-center justify-center"
        style={{ backgroundImage: `url(${assets.LawyeringSkills})` }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-50"></div>
        <h1 className="relative text-white text-2xl sm:text-3xl md:text-5xl font-bold text-center px-4">
          Lawyering Skills
        </h1>
      </div>
      ...
      <div className="min-h-screen bg-white">
        ...
        <section
          id="intro"
          ref={setSectionRef(0)}
          className={`w-full py-12 sm:py-16 px-4 sm:px-6 mt-12 transition-all duration-1000 transform ${
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <blockquote 
              className="text-base sm:text-xl lg:text-2xl leading-relaxed italic"
              style={{ color: '#2D3748' }}
            >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
          {sections.map((section, index) => (
            <section
              ...
              className={`mb-16 sm:mb-24 transition-all duration-1000 transform ${
            ...
            >
              <div 
                className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-6 sm:gap-8 lg:gap-12 rounded-2xl shadow-lg overflow-hidden`}
                style={{ backgroundColor: '#FFFBD6' }}
              >
                {/* Image Section */}
                ...
                <div className="w-full lg:w-1/2 p-6 sm:p-8 lg:p-12">
                  ...
                  <div 
                    className="text-sm sm:text-base lg:text-lg leading-relaxed space-y-4"
                    style={{ color: '#2D3748' }}
                  >
