    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-4 md:gap-8 px-4 md:px-12 py-10">
        ...
        <div className="flex-1 md:w-4/5 bg-white p-6 sm:p-8 rounded-xl shadow-lg border border-gray-200 space-y-4 md:space-y-6 text-gray-700 leading-relaxed text-justify">
          ...
          <p><strong>Eligibility:</strong> Graduation in any stream from a recognized university.</p>
          <p><strong>Course Duration:</strong> 1-year program divided into 2 semesters.</p>

          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-[#920C24]">Why Pursue Cyber Law at BDS?</h2>
          <ul className="list-disc pl-6 space-y-1 md:space-y-2">
            <li>High industry relevance—learn laws shaping data privacy, cybercrime, and digital contracts.</li>
            <li>Hands-on learning through real-world case studies and exposure to the latest cyber law challenges.</li>
            <li>Immediate career value for both law graduates and IT professionals.</li>
            <li>Access to workshops on cyber forensics, blockchain regulations, and AI ethics.</li>
          </ul>

          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-[#920C24]">Life Beyond Classrooms</h2>
          <ul className="list-disc pl-6 space-y-1 md:space-y-2">
            <li>Tech-driven seminars and expert talks on evolving digital policies.</li>
            <li>Workshops on digital forensics, hacking ethics, and cyber investigation.</li>
            <li>Student-led research in cyber policy and IT law.</li>
            <li>Collaborative activities with IT firms and legal tech startups.</li>
          </ul>

          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-[#920C24]">Career Pathways</h2>
          <ul className="list-disc pl-6 space-y-1 md:space-y-2">
            <li><strong>Cyber Law Consultant:</strong> Guide organizations on IT regulations and compliance.</li>
            <li><strong>Data Privacy Officer:</strong> Ensure compliance with global and national data protection laws.</li>
            <li><strong>Cybercrime Investigator:</strong> Assist law enforcement or corporates in investigating online crimes.</li>
            <li><strong>Legal Advisor:</strong> Counsel IT companies and startups on digital contracts and policies.</li>
            <li><strong>Policy & Governance Roles:</strong> Work with governments or NGOs shaping cyber regulations.</li>
          </ul>
